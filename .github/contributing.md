# Contributing to Akkadu_Challenges

First and foremost, thank you! We appreciate that you want to contribute to Akkadu_Challenges, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for Akkadu_Challenges**
...
- **version**: (required) please note the version of Akkadu_Challenges are you using
...
The original poster or the maintainers of Akkadu_Challenges may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/Akkadu_Challenges
