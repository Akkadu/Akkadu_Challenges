!(function (a, t) {
    ...
    return (function (a) {
        ...
        function (a, t, e) {
            ...
            (function (d) {
                Object.defineProperty(t, "__esModule", { value: !0 });
                var n, r = u(e(3)), i = u(e(4)), o = u(e(5)), _ = u(e(6)), g = u(e(7)), m = u(e(8));
                function u(a) {
                    if (a && a.__esModule)
                        return a;
                    var t = {};
                ...
                var f = function () {
                    ...
                    return (l((a = {
                        ...
                        l(a, "green_med_noise", r.green_med_noise_imgdata),
                        l(a, "green_min_noise", r.green_min_noise_imgdata),
                        l(a, "blue_min_noise", r.blue_min_noise_imgdata),
                        l(a, "rosetint", o.rosetint_imgdata),
                        l(a, "purple_min_noise", r.purple_min_noise_imgdata),
                        a);
                };
                (t.default = {
                    filterImg: function (a, t) {
                        var e = f(), d = document.createElement("canvas"), r = a.width || a.naturalWidth, i = a.height || a.naturalHeight;
                        (d.height = i), (d.width = r);
                        var o = d.getContext("2d"), _ = o.createPattern(a, "no-repeat");
                        (o.fillStyle = _),
                            o.fillRect(0, 0, d.width, d.height),
                            (n = o.getImageData(0, 0, d.width, d.height)),
                            console.log(n);
                        var g = e[t](n);
                        console.log(g),
        ...
        function (a, t, e) {
            ...
            var d = e(0), n = void 0, r = void 0;
            (t.red_min_noise_imgdata = function (a) {
                Math.random();
                for (n = 0; n < a.data.length; n += 4) {
                    var t = 0.6 + 0.6 * Math.random(), e = 0.6 + 0.4 * Math.random(), d = 0.6 + 0.4 * Math.random();
                ...
                (t.green_med_noise_imgdata = function (a) {
                    Math.random();
                    for (n = 0; n < a.data.length; n += 4) {
                        var t = 0.6 + 0.5 * Math.random(), e = 0.6 + 0.5 * Math.random(), d = 0.6 + 0.5 * Math.random();
                ...
                (t.green_min_noise_imgdata = function (a) {
                    Math.random();
                    for (n = 0; n < a.data.length; n += 4) {
                        var t = 0.6 + 0.1 * Math.random(), e = 0.6 + 0.5 * Math.random(), d = 0.6 + 0.4 * Math.random();
                        (a.data[n] = 0.99 * a.data[n] * t),
                            (a.data[n + 1] = 0.99 * a.data[n + 1] * e),
                            (a.data[n + 2] = 0.99 * a.data[n + 2] * d);
                    }
                ...
                (t.purple_min_noise_imgdata = function (a) {
                    Math.random();
                    for (n = 0; n < a.data.length; n += 4) {
                        var t = 0.6 + 0.5 * Math.random(), e = 0.6 + 0.2 * Math.random(), d = 0.6 + 0.8 * Math.random();
                        (a.data[n] = 0.99 * a.data[n] * t),
                            (a.data[n + 1] = 0.99 * a.data[n + 1] * e),
                            (a.data[n + 2] = 0.99 * a.data[n + 2] * d);
                    }
                ...
                (t.teal_min_noise_imgdata = function (a) {
                    Math.random();
                    for (n = 0; n < a.data.length; n += 4) {
                        var t = 0.6 + 0.1 * Math.random(), e = 0.6 + 0.5 * Math.random(), d = 0.6 + 0.5 * Math.random();
                        (a.data[n] = 0.99 * a.data[n] * t),
                            (a.data[n + 1] = 0.99 * a.data[n + 1] * e),
                            (a.data[n + 2] = 0.99 * a.data[n + 2] * d);
                    }
                ...
                (t.cosmic_imgdata = function (a) {
                    var t = 0;
                    for (n = 0; n < a.data.length; n += 4)
                        (t = (0, d.getRandomNumber)(0, 200)) > 0 && t < 50
                            ? (0, (r = 30))
                            : t > 49 && t < 100
                                ? (100, (r = 90))
                                : (70, (r = 10)),
                ...
                (t.blue_min_noise_imgdata = function (a) {
                    Math.random();
                    for (n = 0; n < a.data.length; n += 4) {
                        var t = 0.6 + 0.1 * Math.random(), e = 0.6 + 0.2 * Math.random(), d = 0.6 + 0.7 * Math.random();
                        (a.data[n] = 0.99 * a.data[n] * t),
                            (a.data[n + 1] = 0.99 * a.data[n + 1] * e),
                            (a.data[n + 2] = 0.99 * a.data[n + 2] * d);
                    }
                    ...
                    for (n = 0; n < a.data.length; n += 4)
                        (t = (0, d.getRandomNumber)(0, 200)) > 0 && t < 50
                            ...
                            : t > 49 && t < 100
                                ? (10, (r = 90))
                                : (70, (r = 10)),
                            a.data[n] - 0 > 255 ? (a.data[n] -= 0) : (a.data[n] += 0),
                            a.data[n + 1] + 0 > 255
                                ? (a.data[n + 1] -= r)
                                : (a.data[n + 1] += r);
                    return a;
                ...
                (t.min_noise_imgdata = function (a) {
                    Math.random();
                    for (n = 0; n < a.data.length; n += 4) {
                        var t = 0.6 + 0.4 * Math.random(), e = 0.6 + 0.4 * Math.random(), d = 0.6 + 0.4 * Math.random();
                        (a.data[n] = 0.99 * a.data[n] * t),
                            (a.data[n + 1] = 0.99 * a.data[n + 1] * e),
                            (a.data[n + 2] = 0.99 * a.data[n + 2] * d);
                    }
                ...
                (t.pink_min_noise_imgdata = function (a) {
                    Math.random();
                    for (n = 0; n < a.data.length; n += 4) {
                        var t = 0.6 + 0.6 * Math.random(), e = 0.6 + 0.1 * Math.random(), d = 0.6 + 0.4 * Math.random();
                        (a.data[n] = 0.99 * a.data[n] * t),
                            (a.data[n + 1] = 0.99 * a.data[n + 1] * e),
                            (a.data[n + 2] = 0.99 * a.data[n + 2] * d);
                    }
        ...
        function (a, t, e) {
            ...
            (t.offset = function (a) {
                ...
                for (var t = 0; t < a.data.length; t += 4)
                    a.data[t] = void 0 == a.data[t + 100] ? 0 : a.data[t + 20];
                return a;
            }),
                (t.extra_offset_blue = function (a) {
                    for (d = 0; d < a.data.length; d += 4)
                        a.data[d + 2] = void 0 == a.data[d + 900] ? 0 : a.data[d + 60];
                    return a;
                }),
                (t.extra_offset_green = function (a) {
                    for (d = 0; d < a.data.length; d += 4)
                        a.data[d + 1] = void 0 == a.data[d + 900] ? 0 : a.data[d + 60];
                    return a;
                }),
                (t.extra_offset_red = function (a) {
                    for (d = 0; d < a.data.length; d += 4)
                        a.data[d] = void 0 == a.data[d + 900] ? 0 : a.data[d + 60];
                    return a;
                }),
                (t.extreme_offset_blue = function (a) {
                    for (d = 0; d < a.data.length; d += 4)
                        a.data[d + 2] = void 0 == a.data[d + 4900] ? 0 : a.data[d + 140];
                    return a;
                }),
                (t.extreme_offset_green = function (a) {
                    for (d = 0; d < a.data.length; d += 4)
                        a.data[d + 1] = void 0 == a.data[d + 4900] ? 0 : a.data[d + 140];
                    return a;
                }),
                (t.extreme_offset_red = function (a) {
                    for (d = 0; d < a.data.length; d += 4)
                        a.data[d] = void 0 == a.data[d + 4900] ? 0 : a.data[d + 140];
                    return a;
                }),
                (t.offset_green_imgdata = function (a) {
                    for (d = 0; d < a.data.length; d += 4)
                        a.data[d + 1] = void 0 == a.data[d + 100] ? 0 : a.data[d + 20];
                    return a;
                }),
                (t.offset_blue_imgdata = function (a) {
                    for (d = 0; d < a.data.length; d += 4)
                        a.data[d + 2] = void 0 == a.data[d + 100] ? 0 : a.data[d + 20];
                    return a;
                });
        },
        function (a, t, e) {
            ...
            (t.blues_imgdata = function (a) {
                ...
                (t.aeon_imgdata = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        (a.data[n + 1] = 60 - a.data[n + 1]),
                            (a.data[n + 2] = 100 - a.data[n + 2]);
                    return a;
                }),
                ...
                (t.wood = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        (a.data[n] = a.data[n] + 30), (a.data[n + 1] = a.data[n + 1] + 12);
                    return a;
                }),
                (t.sunset = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        (a.data[n + 1] = a.data[n] + 50),
                            (a.data[n + 2] = a.data[n + 2] + 12);
                    return a;
                }),
                ...
                (t.coral_imgdata = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        a.data[n + 2] = a.data[n + 1] + 50;
                    return a;
                }),
                (t.frontward_imgdata = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        (a.data[n] = a.data[n + 2]), (a.data[n + 2] = a.data[n + 1] + 50);
                    return a;
                }),
                ...
                (t.perfume_imgdata = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        (a.data[n] += 80), (a.data[n + 1] += 40), (a.data[n + 2] += 120);
                    return a;
                }),
                (t.vintage_imgdata = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        (a.data[n] += 120), (a.data[n + 1] += 70), (a.data[n + 2] += 13);
                    return a;
                }),
                (t.serenity_imgdata = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        (a.data[n] += 10), (a.data[n + 1] += 40), (a.data[n + 2] += 90);
                    return a;
                }),
                ...
                (t.warmth = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        (a.data[n] = a.data[n] + 10), (a.data[n + 1] = a.data[n + 1] + 18);
                    return a;
                }),
                ...
                (t.grime = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        (a.data[n + 1] = a.data[n] + 5), (a.data[n] = a.data[n] + 1);
                    return a;
                }),
                (t.phase = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        (a.data[n] = a.data[n] + (0, d.getRandomNumber)(10, 20)),
                            (a.data[n + 1] = a.data[n + 2] + (0, d.getRandomNumber)(10, 20)),
                            (a.data[n + 2] = a.data[n + 2] + (0, d.getRandomNumber)(10, 20));
                    return a;
                }),
                (t.crimson = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        (a.data[n] = a.data[n] + 20), (a.data[n + 1] = a.data[n + 2] + 20);
                    return a;
                }),
                ...
                (t.ocean_imgdata = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        (a.data[n] += 10), (a.data[n + 1] += 20), (a.data[n + 2] += 90);
                    return a;
                }),
                ...
                (t.solange_dark_imgdata = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        a.data[n] = 200 - a.data[n];
                    return a;
                }),
                (t.pink_aura_imgdata = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        (a.data[n] += 90), (a.data[n + 1] += 10), (a.data[n + 2] += 90);
                    return a;
                }),
                (t.haze_imgdata = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        (a.data[n] += 90), (a.data[n + 1] += 90), (a.data[n + 2] += 10);
                    return a;
                }),
                (t.mellow_imgdata = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        a.data[n + 2] = 120 - a.data[n + 2];
                    return a;
                }),
                (t.evening_imgdata = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        (a.data[n] -= 60), (a.data[n + 1] -= 60), (a.data[n + 2] -= 60);
                    return a;
                }),
                (t.horizon_imgdata = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        (a.data[n] -= 150), (a.data[n + 1] -= 150), (a.data[n + 2] -= 150);
                    return a;
                }),
        ...
        function (a, t, e) {
            ...
            var d = e(0), n = void 0, r = void 0, i = void 0;
            (t.casino_imgdata = function (a) {
                ...
                (t.yellow_casino_imgdata = function (a) {
                    var t = 0, e = 0;
                    for (n = 0; n < a.data.length; n += 4) {
                        (t = (0, d.getRandomNumber)(0, 255)),
                            (e = (0, d.getRandomNumber)(0, 255)),
                            t > 255 && (t = 0);
                    ...
                    for (n = 0; n < a.data.length; n += 4) {
                        ...
                        (t = (0, d.getRandomNumber)(0, 200)) > 0 && t < 50
                            ...
                            : t > 49 && t < 100
                                ? ((e = 20), (r = 90))
                                : ((e = 10), (r = 50)),
                            a.data[n] - e > 255 ? (a.data[n] -= e) : (a.data[n] += e),
                            a.data[n + 2] + r > 255
                                ? (a.data[n + 2] -= r)
                                : (a.data[n + 2] += r);
                    }
                    ...
                    for (n = 0; n < a.data.length; n += 4)
                        (t = (0, d.getRandomNumber)(0, 200)) > 0 && t < 50
                            ...
                            : t > 49 && t < 100
                                ...
                                : ((r = 30), (i = 10)),
                            a.data[n] + 0 > 255 ? (a.data[n] -= 0) : (a.data[n] += 0),
                            a.data[n + 1] + 0 > 255 ? (a.data[n + 1] -= i) : (a.data[n] += i);
                    return a;
                }),
                ...
                (t.specks_imgdata = function (a) {
                    var t = 0, e = 0;
                    for (n = 0; n < a.data.length; n += 4) {
                        (n = (0, d.getRandomNumber)(0, a.data.length)),
                            (t = (0, d.getRandomNumber)(0, 255)),
                            (e = (0, d.getRandomNumber)(0, 255)),
                            (0, d.getRandomNumber)(0, 255),
                            t > 255 && (t = 0);
                        var r = (a.data[n] + a.data[n + 1] + a.data[n + 2]) / 3;
                        (a.data[n] = r + t),
                            (a.data[n + 1] = r + e),
                ...
                (t.specksredscale_imgdata = function (a) {
                    for (n = 0; n < a.data.length; n += 4) {
                        ...
                        t > 10 &&
                            t < 13 &&
                            ((a.data[n] = 120), (a.data[n + 1] = 120), (a.data[n + 2] = 120));
                        var e = (a.data[n] + a.data[n + 1] + a.data[n + 2]) / 3;
                        (a.data[n] = e + 100),
                            (a.data[n + 1] = e + 40),
                            (a.data[n + 2] = e + 20);
        ...
        function (a, t, e) {
            ...
            (t.sat_adj_imgdata = function (a) {
                ...
                (t.incbrightness_imgdata = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        (a.data[n] += 50), (a.data[n + 1] += 50), (a.data[n + 2] += 50);
                    return a;
                }),
                ...
                (t.darkify_imgdata = function (a) {
                    for (n = 0; n < a.data.length; n += 4)
                        (a.data[n] -= 20), (a.data[n + 1] -= 20), (a.data[n + 2] -= 20);
                    return a;
                }),
