...
<Navbar />
  <div class="container">
    <div class="d-flex justify-content-end">
      <button class="btn btn-primary mt-4" data-bs-toggle="modal" data-bs-target="#addProductModal">Create Product</button>
    </div>
      ...
      <div class="card p-3 m-2 w-100">
            ...
            <div class="mt-2">
                ...
                <div class="mt-2">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="ratings">
                          <fa-icon v-for="i in product.averageStars" :key="i" icon="star" regular class="text-warning"></fa-icon>
                          <fa-icon v-for="i in 5 - (product?.averageStars || 0)" :key="i" :icon="['far', 'star']" regular class="text-primary"></fa-icon>
                        </div>
                    </div>
                    <div>
                      <nuxt-link :to="'products/' + product.id + '/reviews'">{{ product.reviewsCount }} Reviews</nuxt-link>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex">
          <div class="flex-grow-1">
            ...
            <button class="btn btn-success mx-2" data-bs-toggle="modal" data-bs-target="#addReviewModal" @click="setCurrentProduct(product)">Add Review</button>
        </div>
    </div>
    </div>
...
<div id="addProductModal" class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="Add Product" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
                        <div class="mt-2 mr-4">
                    ...
                    <div>
                      ...
                      <div>
                        <div class="modal-footer border-top-0">
                          <button ref="CloseAddProduct" type="button" class="btn btn-light" data-bs-dismiss="modal">Cancel</button>
